...
SIDES = {
    ...
    ("mandible", "surangular"): "lateral",
    ("mandible", "angular"): "ventral",
    ("mandible", "articular"): "posterior",
    ("mandible", "dentary"): "anterior",
    ("mandible", "coronoid"): "dorsal",
    ("otic-capsule", "prootic"): "anterior",
    ("otic-capsule", "opisthotic"): "posterior",
    ("occiput", "supraoccipital"): "dorsal",
    ...
    ("scapulocoracoid", "articular-process-pectoral"): "lateral",
    ("fin-radials", "preaxial-radials"): "anterior",
