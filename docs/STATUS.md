...
<!-- counts:parked -->
66 extracted observations from 2 sources are waiting for a record (28 on no-record, 26 on nomenclature, 11 on division, 1 on homology). They carry no coverage weight — they are mining already done.
<!-- /counts:parked -->
