...
|---|---|---|
| Cranial musculature | 15 | Werneburg 2011; Johnston 2011, 2014; Ziermann & Diogo 2019 |
...
<!-- counts:summary -->
Taxon-specific attachments cover **62%** of 626 present occurrences. The thinnest columns of any size are Testudines at 26%, Anura at 35%, Aves at 49%; the thinnest regions are hand, axial, forearm. `side` is on 58% of observed rows and `landmark` on 23%; `layer` resolves for 56 of 96 appendicular muscles; architecture data covers 21 muscle–taxon pairs across 2 taxa.
<!-- /counts:summary -->
