...
<!-- counts:summary -->
Taxon-specific attachments cover **65%** of 643 present occurrences. The thinnest columns of any size are Testudines at 26%, Chondrichthyes at 41%, Aves at 49%; the thinnest regions are hand, axial, forearm. `side` is on 58% of observed rows and `landmark` on 22%; `layer` resolves for 56 of 96 appendicular muscles; architecture data covers 21 muscle–taxon pairs across 2 taxa.
<!-- /counts:summary -->
