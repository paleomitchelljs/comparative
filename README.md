...
<!-- counts:summary -->
Taxon-specific attachments cover **61%** of 623 present occurrences. The thinnest columns of any size are Testudines at 26%, Anura at 35%, Aves at 49%; the thinnest regions are cranial, hand, axial. `side` is on 59% of observed rows and `landmark` on 23%; `layer` resolves for 56 of 96 appendicular muscles; architecture data covers 21 muscle–taxon pairs across 2 taxa.
<!-- /counts:summary -->
